      ...
      <div class="row">
        <div class="col-lg-5 md-text-center">
          <div class="layer-style" data-aos="fade-up" data-aos-duration="1000">
            <div class="thumb tilt-animation">
              <img src="/images/about/about1.jpg" alt="Images" />
            </div>
            ...
            <div class="experience-time">
              <div class="content">
                32<sup>+</sup> <span>Years of Experience</span>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-6 offset-lg-1">
          <div class="about-content">
            <div
              class="section-title xs-text-center"
              data-aos="fade-up"
              data-aos-duration="1000"
            >
              <h2 class="title">
                We Have Leadership Strong
                <span class="bottom-style">Experience</span> In Business.
              </h2>
              <div class="desc">
                <p class="mt-20">
                  Lorem Ipsum is simply dummy text of the printing and
                  typesetting industry standard dummy text ever
                  <u class="text-theme-color2"
                    >since the 1500s, when an unknown printer took</u
                  >
                  type specimen book survived not only centuries.
                </p>
              </div>
            </div>
            <div
              class="list-icon-style"
              data-aos="fade-up"
