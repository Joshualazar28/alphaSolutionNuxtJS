import { version, getCurrentInstance, useSSRContext, createApp, reactive, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, hasInjectionContext, inject, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, withCtx, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }], "link": [], "style": [], "script": [], "noscript": [], "title": "Virtuf" };
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-856ee17f.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-details",
    path: "/blog-details",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/blog-details-4f4569b7.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/blog-6acd9fbc.mjs').then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contact-f4ffa443.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-c0765d50.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/project-details-f64de2ea.mjs').then((m) => m.default || m)
  },
  {
    name: "project",
    path: "/project",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/project-4ba8e1b3.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/service-details-83ea5423.mjs').then((m) => m.default || m)
  },
  {
    name: "service",
    path: "/service",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/service-fd23c061.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-3cb4239e.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-e3223771.mjs').then((r) => r.default || r));
