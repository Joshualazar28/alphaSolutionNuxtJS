...
import { a as __nuxt_component_0, b as __nuxt_component_1, _ as _imports_1$1 } from './logo-db90386b.mjs';
import __nuxt_component_2 from './PageTitle-91a918ca.mjs';
import { useSSRContext, mergeProps } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate } from 'vue/server-renderer';
import { _ as _export_sfc } from '../server.mjs';
import { _ as _imports_1 } from './line-s4-98b62ee4.mjs';
import { a as __nuxt_component_4$1, b as __nuxt_component_5, _ as _imports_0$1 } from './Footer-5a36eb2a.mjs';
import { _ as __nuxt_component_7, a as __nuxt_component_6 } from './TestimonialOne-acda319e.mjs';
...
const _imports_0 = "" + publicAssetsURL("images/about/grow1.jpg");
const _sfc_main$1 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "about-area" }, _attrs))}><div class="position-relative"><div class="container"><div class="row"><div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-6 offset-xl-0"><div class="layer-about-style" data-aos="fade-up" data-aos-duration="1000"><div class="thumb tilt-animation"><img${ssrRenderAttr("src", _imports_0)} alt="image"></div><div class="shape-style1"><img${ssrRenderAttr("src", _imports_1$1)} alt="image"></div><div class="experience-time"><div class="content"> 32<sup>+</sup><div class="line-separetor"><img${ssrRenderAttr("src", _imports_1)} alt="image"><img${ssrRenderAttr("src", _imports_1)} alt="image"></div><span>Years of Experience</span></div></div></div></div><div class="col-lg-12 col-xl-6"><div class="about-content-style2"><div class="section-title" data-aos="fade-up" data-aos-duration="1000"><div class="subtitle-content"><img${ssrRenderAttr("src", _imports_0$1)} alt="image"><h5>About Us.</h5></div><h2 class="title">Ensuring every customer interaction is <span>exceptional.</span></h2><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry standard dummy text ever centuries.</p></div><div class="inner-content" data-aos="fade-up" data-aos-duration="1200"><p><span class="text-block">B</span>omply dummy text of the printing and typesetting industry. has standard dummy text ever since the 1500s, when an unknown printer scrambled it to make a type and specimen book. It has survived not only five leap into electronic typesetting, remaining essentially unchanged popularise with the release Letraset sheets containing.</p><p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type electronic typesetting, remaining essentially.</p><div class="inline-style"><a href="#" class="btn btn-theme btn-border"> Team Members <i class="icon icofont-long-arrow-right"></i></a></div></div></div></div></div></div></div></section>`);
}
...
//# sourceMappingURL=about-856ee17f.mjs.map
