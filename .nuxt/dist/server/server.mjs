...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-856ee17f.js").then((m) => m.default || m)
  },
  {
    name: "blog-details",
    path: "/blog-details",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/blog-details-4f4569b7.js").then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/blog-6acd9fbc.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/contact-f4ffa443.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-c0765d50.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/project-details-f64de2ea.js").then((m) => m.default || m)
  },
  {
    name: "project",
    path: "/project",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/project-4ba8e1b3.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/service-details-83ea5423.js").then((m) => m.default || m)
  },
  {
    name: "service",
    path: "/service",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/service-fd23c061.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-3cb4239e.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-e3223771.js").then((r) => r.default || r));
