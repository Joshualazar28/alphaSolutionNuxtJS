import { _ as _imports_1$2, h as _imports_4$1, i as _imports_5, j as _imports_6, c as _imports_1$3, a as __nuxt_component_0$3, b as __nuxt_component_1 } from "./logo-db90386b.js";
...
import { resolveComponent, mergeProps, withCtx, createTextVNode, createVNode, useSSRContext, toDisplayString } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate } from "vue/server-renderer";
import { _ as _imports_0$2, a as __nuxt_component_4$1, b as __nuxt_component_5$1 } from "./Footer-5a36eb2a.js";
import { _ as _export_sfc } from "../server.mjs";
import { _ as __nuxt_component_0$2 } from "./ServiceItem-af0770f9.js";
import { _ as _imports_0$3 } from "./line-s2-d4bf72eb.js";
import { a as __nuxt_component_6, _ as __nuxt_component_7 } from "./TestimonialOne-acda319e.js";
import "ufo";
import "hookable";
import "ofetch";
...
import "destr";
import "defu";
const _imports_1$1 = "" + __publicAssetsURL("images/slider/line1.jpg");
const _imports_2$1 = "" + __publicAssetsURL("images/shape/2.png");
const _imports_7 = "" + __publicAssetsURL("images/slider/header2.jpg");
        ...
        _push2(ssrRenderComponent(_component_swiper_slide, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              _push3(`</div><div class="layer-style"${_scopeId2}><div class="thumb"${_scopeId2}><img${ssrRenderAttr("src", _imports_7)} alt="Images"${_scopeId2}></div><div class="success-rate"${_scopeId2}><div class="content"${_scopeId2}>85% <span${_scopeId2}>Successful Project</span></div></div><div class="shape-style1"${_scopeId2}><img${ssrRenderAttr("src", _imports_1$2)} alt="Images"${_scopeId2}></div><div class="shape-style2"${_scopeId2}><img${ssrRenderAttr("src", _imports_2$1)} alt="Images"${_scopeId2}></div><div class="shape-style3"${_scopeId2}><img${ssrRenderAttr("src", _imports_4$1)} alt="Images"${_scopeId2}></div><div class="shape-style4"${_scopeId2}><img${ssrRenderAttr("src", _imports_5)} alt="Images"${_scopeId2}></div><div class="shape-style5"${_scopeId2}><img${ssrRenderAttr("src", _imports_6)} alt="Images"${_scopeId2}></div></div></div>`);
            } else {
              return [
                createVNode("div", { class: "slider-content-area" }, [
                  createVNode("div", { class: "content" }, [
...
const _imports_0$1 = "" + __publicAssetsURL("images/about/about1.jpg");
const _imports_1 = "" + __publicAssetsURL("images/shape/circle-line1.png");
const _sfc_main$5 = {};
...
const _imports_2 = "" + __publicAssetsURL("images/shape/6.png");
const _imports_3$1 = "" + __publicAssetsURL("images/shape/7.png");
const _sfc_main$4 = {
  data() {
    return {
      services: [
...
const _imports_0 = "" + __publicAssetsURL("images/photos/faq01.jpg");
const _imports_3 = "" + __publicAssetsURL("images/shape/circle-line2.png");
const _imports_4 = "" + __publicAssetsURL("images/shape/circle-line3.png");
const _sfc_main$2 = {
  components: {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></div></div></div></div><div class="layer-shape"><div class="layer-shape-one" data-aos="fade-up" data-aos-duration="1000"><img class="img-shape1 tilt-animation"${ssrRenderAttr("src", _imports_0)} alt="Virtuf-Image"><img class="img-shape2"${ssrRenderAttr("src", _imports_1$2)} alt="Virtuf-Image"><img class="img-shape3"${ssrRenderAttr("src", _imports_2$1)} alt="Virtuf-Image"></div><div class="layer-shape-two"><img${ssrRenderAttr("src", _imports_3)} alt="Virtuf-Image"></div><div class="layer-shape-three"><img${ssrRenderAttr("src", _imports_4)} alt="Virtuf-Image"></div></div></section>`);
}
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$1;
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "blog-area blog-default-area" }, _attrs))}><div class="container"><div class="row"><div class="col-lg-6 m-auto"><div class="section-title text-center" data-aos="fade-up" data-aos-duration="1000"><h2 class="title">News Of Company</h2><div class="separator-line mt-14"><img class="me-1"${ssrRenderAttr("src", _imports_0$3)} alt="image"><img${ssrRenderAttr("src", _imports_1$3)} alt="image"></div><div class="desc"><p class="mt-21">Lorem Ipsum is simply dummy text of the printing and typesetting industry has been the industry&#39;s standard dummy text ever since the printer took</p></div></div></div></div><div class="row" data-aos="fade-up" data-aos-duration="1100"><!--[-->`);
...
const _sfc_main = {
  components: {
    ...
    PortfolioSection: () => import("./PortfolioSection-f6749236.js"),
...
//# sourceMappingURL=index-c0765d50.js.map
